...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', default='ISBI/images', type=str,
                        help='the path of dataset')
    parser.add_argument('--csvfile', default='./src/ISBI/test_train_data.csv', type=str,
                        help='two columns [image_id,category(train/test)]')
    parser.add_argument('--model', default='save_models/2023_12_21_21epoch_last.pth', type=str,
                        help='the path of model')
    parser.add_argument('--debug', default=True, type=bool, help='plot background')
    ...
    for image_id in test_files:
        img = cv2.imread(f'{args.dataset}{image_id}')
    ...
    print('Dice:', round(np.mean(dice_score), 4), round(np.std(dice_score), 4))
